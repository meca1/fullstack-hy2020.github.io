...
El mundo de JavaScript se desarrolla rápidamente, lo que conlleva sus propios desafíos. Las herramientas, las librerías y el propio lenguaje están en constante desarrollo. Algunos están empezando a cansarse del cambio constante y han acuñado un término para ello: <em>fatiga de JavaScript</em>. [cómo administrar la fatiga de JavaScript en auth0](https://auth0.com/blog/how-to-manage-javascript-fatigue/) o [Fatiga de JavaScript en Medium](https://medium.com/@ericclemmons/javascript-fatigue-48d4011b6fc4).
